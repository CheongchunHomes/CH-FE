            ...
            <AccordionItem value="대출" className="overflow-hidden rounded-xl border border-gray-200 bg-white">
              <AccordionTrigger className="px-4 py-3.5 hover:no-underline">
                <div className="flex items-center gap-2.5">
                  ...
                  <a href="/site/step/loan-contract?product=newborn" onClick={e => e.stopPropagation()} className="ml-auto mr-2 inline-flex items-center rounded-md border border-blue-200 bg-white px-3 py-1 text-xs font-semibold text-blue-600 hover:bg-blue-50">신청하기</a>
                </div>
              </AccordionTrigger>
              <AccordionContent className="pb-0">
                <div className="border-t border-gray-100">
